...
from .views import TaskList, TaskDetail, TaskCreate, TaskUpdate, DeleteView, CustomLoginView, RegisterPage, ActivateAccount
...
urlpatterns = [
    ...
    path('reset/<uidb64>/<token>',
         auth_views.PasswordResetConfirmView.as_view(template_name='Account_Management/password_reset_form.html'),
         name='password_reset_confirm'),  # Link to password reset form in email
    path('reset_password_complete',
         auth_views.PasswordResetCompleteView.as_view(template_name='Account_Management/password_reset_done.html'),
